    ...
    images: [
      {
        ...
        content: [
          ...
          'The game revolves around the simple mechanic of clicking a cookie to earn even more cookies, then investing various resources to automate the cookie-making process.',
